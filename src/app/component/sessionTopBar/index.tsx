    ...
    <header className="sticky top-0 left-0 right-0 bg-white/95 shadow-sm backdrop-blur-sm z-50 border-b border-gray-100">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        ...
        <div className="flex items-center space-x-6">
          ...
          <button
            className="px-4 py-2 text-white rounded-md bg-[#ff0000] text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pinky-deepRed"
            onClick={async () => {
