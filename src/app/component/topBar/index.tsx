    ...
    <header className="fixed top-0 left-0 right-0 bg-white backdrop-blur-sm z-50">
      <nav className="max-w-7xl mx-auto px-4 flex items-center justify-between h-14 md:h-16">
        <Link
          ...
          className="font-medium hover:text-pink-600 transition-colors text-black"
        >
          About Me
        </Link>
        <div className="flex items-center gap-6">
          ...
          <Link
            href="/login"
            className="px-6 py-2 h-12 bg-pink-base text-white rounded-lg hover:bg-pink-700 transition-colors "
          >
            Log In
          </Link>
        </div>
